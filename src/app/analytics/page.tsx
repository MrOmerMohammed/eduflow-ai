...
export default async function AnalyticsPage({ searchParams }: { searchParams: Promise<{ schoolId?: string; academicYearId?: string }> }) {
  ...
  return <AnalyticsBoard schoolId={membership.school_id} school={{name:school.name,code:school.code}} years={years??[]} initialYearId={yearId}/>;
}
