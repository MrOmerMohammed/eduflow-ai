  ...
  return (
    <main className="app-shell">
      ...
      <section className="dashboard">
        <header className="topbar"><div><p className="eyebrow">V3 · Student Information System</p><h1>Student 360</h1></div><Link className="secondary-link" href="/students">Back to students</Link></header>
